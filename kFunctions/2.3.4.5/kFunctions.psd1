#
# Module manifest for module 'kFunctions'
#
...
GUID = 'b34f2edd-8b9d-41b8-945c-87ed1ccfb99b'
...
Description = 'PowerShell Advanced Functions for Kubernetes.'
...
FileList = 'kFunctions.psd1', 'kFunctions.psm1', 'kClass.psm1'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = 'API', 'MicroK8s', 'K3s', 'K8s', 'Kubernetes'
